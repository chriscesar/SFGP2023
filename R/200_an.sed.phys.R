...
performance::check_posterior_predictions(ang_cur_mod3)
...
anova(com_cur_mod1,com_cur_mod2,com_cur_mod3,com_cur_mod3.1)
AIC(com_cur_mod1,com_cur_mod2,com_cur_mod3,com_cur_mod3.1)
### Lowest AIC = com_cur_mod3.1
summary(com_cur_mod3.1)
print(com_cur_mod3,cor=FALSE)
anova(com_cur_mod3)
